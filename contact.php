...
<html lang="en">
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <div class="container">
          <div class="row">
            <div class="text-center">
              <h1 class="display-3 text-uppercase text-dark">Contact Us</h1>
    ...
    <section id="contact-us" class="padding-medium">
      <div class="container-lg">
        <div class="row g-lg-5">
          <div class="contact-info col-lg-6">
            <h2 class="display-6 fw-semibold">Contact information</h2>
  
            <p>Get in touch with us for any questions or support—we’re here to help!
              ...
              <div class="col-lg-6 col-sm-12">
                <div class="content-box pe-4 mb-5">
                  ...
                  <div class="contact-number">
                    <p>
                      <a href="#"> +1 239 873 2100</a>
                    </p>
                   
                  </div>
                  <div class="email-address">
                    <p>
                      <a href="#">contactoffice@floracosmeticsusa.com</a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="inquiry-item col-lg-6 mt-5 ">
            <div class="rounded-5">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6">
            <div class="image-holder text-center mb-5">
              <img src="images/main-logo.png" style="height:100px;" style="height:100px;" alt="logo">
            </div>

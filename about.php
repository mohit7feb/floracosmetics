...
<html lang="en">
  <head>
    <title>Flora - Skincare Products Ecommerce Website Template</title>
    <meta charset="utf-8">
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <symbol xmlns="http://www.w3.org/2000/symbol" id="arrow-left-light" viewBox="0 0 256 256">
        <path fill="currentColor" d="M220 128a4 4 0 0 1-4 4H49.66l65.17 65.17a4 4 0 0 1-5.66 5.66l-72-72a4 4 0 0 1 0-5.66l72-72a4 4 0 0 1 5.66 5.66L49.66 124H216a4 4 0 0 1 4 4Z" />
      </symbol>
            ...
            <div class="offcanvas offcanvas-end order-3" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
              <div class="offcanvas-body align-items-center">
                <div class="offcanvas-header p-0 py-4">
                  <button type="button" class="btn-close btn-close-black shadow-none" data-bs-dismiss="offcanvas" aria-label="Close" data-bs-target="#bdNavbar"></button>
                </div>
                  ...
                  <div class="navbar-collapse order-1 order-lg-1" id="navbarMenu">
                    <ul class="navbar-nav mr-auto">
                      ...
                      <!-- <li class="nav-item dropdown">
                        <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Shop</a>
                        <ul class="dropdown-menu">
                          <li>
                            <a href="shop.html" class="dropdown-item">Shop <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="single-product.html" class="dropdown-item">Single Product <span class="badge bg-primary">PRO</span></a>
                          </li>
                        </ul>
                      </li>
                      <li class="nav-item dropdown">
                        <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Blog</a>
                        <ul class="dropdown-menu">
                          <li>
                            <a href="blog.html" class="dropdown-item">Blog <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="single-post.html" class="dropdown-item">Single Post <span class="badge bg-primary">PRO</span></a>
                          </li>
                        </ul>
                      </li> -->
                      <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li>
                            <a href="wishlist.html" class="dropdown-item">Wishlist <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="checkout.html" class="dropdown-item">Checkout <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="contact.php" class="dropdown-item">Contact <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="faqs.html" class="dropdown-item">FAQs <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="account.html" class="dropdown-item">Account <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="team.html" class="dropdown-item">Team <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="thank-you.html" class="dropdown-item">Thankyou <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="error.html" class="dropdown-item">Error <span class="badge bg-primary">PRO</span></a>
                          </li>
                          <li>
                            <a href="styles.html" class="dropdown-item">Style <span class="badge bg-primary">PRO</span></a>
                          </li> -->
                        </ul>
                      </li>
                      <!-- <li class="nav-item mt-4 mt-lg-0">
                        <a class="btn btn-primary m-0 rounded-pill" href="https://templatesjungle.gumroad.com/l/flores-skin-care-products-html-template" target="_blank">GET PRO</a>
                      </li> -->
                    </ul>
                  </div>
                </div>
                ...
                <!-- <div class="col-md-5">
                  <ul class="user-items list-unstyled d-none d-lg-flex justify-content-end align-items-center order-3 flex-grow-1 gap-4 m-0">
                    ...
                    <li>
                      <a href="cart.html" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
    ...
    <section class="hero-section light-content jarallax">
      <img src="images/hero-image1.jpg" class="jarallax-img">
      <div class="hero-content py-lg-8">
        <div class="container">
          <div class="row">
            <div class="text-center">
              <h1 class="display-3 text-uppercase text-dark">About Us</h1>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-10 mx-auto text-center">
            <blockquote class="fs-4">Welcome to Flora Cosmetics, your premier destination for top-tier beauty products. We are passionate about helping you achieve your best skin with high-quality, effective solutions tailored to your unique needs. Our carefully curated selection features innovative formulas and trusted brands, ensuring you receive only the best in skincare.</blockquote>
          </div>
          <div class="col-lg-10 mx-auto text-center mt-5">
            <blockquote class="fs-4">At Flora Cosmetics, we are dedicated to enhancing your natural beauty and providing a seamless shopping experience. Our commitment to excellence extends from our product offerings to our customer service, making sure you have everything you need to maintain radiant, healthy skin. Explore our collection and let us support your journey to glowing, beautiful skin.</blockquote>
          </div>
        </div>
      </div>
    </section>
    <section id="company-services" class="py-lg-5">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="team-member mb-4">
                <img src="images/team-member1.jpg" alt="post" class="img-fluid rounded-4">
                <div class="member-details mt-3 text-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="team-member mb-4">
                <img src="images/team-member2.jpg" alt="post" class="img-fluid rounded-4">
                <div class="member-details mt-3 text-center">
                  <h4 class="member-title">Ms Patrik Smith</h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="team-member mb-4">
                <img src="images/team-member3.jpg" alt="post" class="img-fluid rounded-4">
                <div class="member-details mt-3 text-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="team-member mb-4">
                <img src="images/team-member4.jpg" alt="post" class="img-fluid rounded-4">
                <div class="member-details mt-3 text-center">
    ...
    <div class="footer-bottom text-center border-top pt-3">
      <p>© 2024 Copyright <a href="#" class="fw-bold"> Flora Cosmetics</a>. All rights reserved </p>
    </div>
